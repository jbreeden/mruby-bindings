...
#define BIND_NnCmsghdr_TYPE FALSE
...
#define BIND_NnCp_TYPE FALSE
#define BIND_NnCp_INITIALIZE FALSE

#define BIND_NnCtx_TYPE FALSE
#define BIND_NnCtx_INITIALIZE FALSE

#define BIND_NnEp_TYPE FALSE
#define BIND_NnEp_INITIALIZE FALSE

#define BIND_NnEpOptions_TYPE FALSE
...
#define BIND_NnPipe_TYPE FALSE
#define BIND_NnPipe_INITIALIZE FALSE

#define BIND_NnPipebase_TYPE FALSE
...
#define BIND_NnPipebaseVfptr_TYPE FALSE
...
#define BIND_NnPollfd_TYPE FALSE
...
#define BIND_NnSocktype_TYPE FALSE
...
#define BIND_NnSymbolProperties_TYPE FALSE
...
#define BIND_NnTransport_TYPE FALSE
...
#define BIND_nn_bind_FUNCTION TRUE
#define BIND_nn_close_FUNCTION TRUE
#define BIND_nn_cmsg_nxthdr__FUNCTION FALSE
#define BIND_nn_connect_FUNCTION TRUE
#define BIND_nn_device_FUNCTION TRUE
...
#define BIND_nn_errno_FUNCTION TRUE
#define BIND_nn_freemsg_FUNCTION FALSE
#define BIND_nn_getsockopt_FUNCTION TRUE
...
#define BIND_nn_socket_FUNCTION TRUE
#define BIND_nn_strerror_FUNCTION TRUE
#define BIND_nn_symbol_FUNCTION FALSE
#define BIND_nn_symbol_info_FUNCTION FALSE
#define BIND_nn_term_FUNCTION TRUE
