...
module MRuby::Bindings
  ...
  CTypes.define(CTypes.any_constness_and_sign('char', 'short', 'long', 'int', 'long long', 'size_t',
                                              'int64_t', 'uint64_t', 'int32_t', 'uint32_t')) do
...
MRuby::Bindings::Hooks.define_builtin_ctypes
