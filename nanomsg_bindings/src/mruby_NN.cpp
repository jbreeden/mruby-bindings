...
#define nn_getsockopt_REQUIRED_ARGC 5
...
mrb_NN_nn_getsockopt(mrb_state* mrb, mrb_value self) {
  ...
  /* Fetch the args */
  mrb_get_args(mrb, "ooooo", &s, &level, &option, &optval, &optvallen);
  ...
  /* Invocation */
  int result = nn_getsockopt(native_s, native_level, native_option, native_optval, native_optvallen);
...
#define nn_recv_REQUIRED_ARGC 4
...
mrb_NN_nn_recv(mrb_state* mrb, mrb_value self) {
  ...
  /* Fetch the args */
  mrb_get_args(mrb, "oooo", &s, &buf, &len, &flags);
  ...
  /* Invocation */
  int result = nn_recv(native_s, native_buf, native_len, native_flags);
...
#define nn_send_REQUIRED_ARGC 4
...
mrb_NN_nn_setsockopt(mrb_state* mrb, mrb_value self) {
  ...
  /* Invocation */
  int result = nn_setsockopt(native_s, native_level, native_option, native_optval, native_optvallen);
